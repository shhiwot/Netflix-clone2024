...
const Header = () => {
  ...
  return (
    <>
      <div className={classes.header_outer_wrapper}>
    
          <div className={classes.LeftSide_container}>
            ...
            <nav className={classes.Nav_list}>
              ...
              <div>
                <a href="/home">TvShows</a>
              </div>
              <div>
                <a href="/home">Movies</a>
              </div>
              <div>
                <a href="/home">Another action</a>
              </div>
              <div>
                <a href="/home">New & Popular</a>
              </div>
              <div>
                <a href="/home">MyList</a>
              </div>
              <div>
